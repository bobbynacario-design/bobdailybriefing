(function (root) {
  ...
  function ahaRules() {
    return [
      ...
      '- title: the read itself in at most 12 words — a claim, not a topic.',
      ...
      '- wrong_if: ONE checkable signal that would show the read is wrong — what it is, who publishes it, and when it is next due. Same standard as watch_metric.',
  ...
  var api = {buildBriefingPrompt: buildBriefingPrompt, defaultDateLabel: defaultDateLabel, buildReaderFeedback: buildReaderFeedback, cleanAha: cleanAha};
