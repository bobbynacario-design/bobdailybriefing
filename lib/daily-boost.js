...
(function(root) {
  ...
  var FIELDS = ['energy','spark','done','tucked','note','carry','ref','refSource','refUrl','picked','intention','trialPlan','trialDue','trialOutcome','trialDone','trialSource','trialResult','trialNext','sparkResponse'];
  ...
  var ARCHIVE_FIELDS = ['energy','spark','done','note','carry','ref','refSource','refUrl','stories','reminders','intention','trialPlan','trialDue','trialOutcome','trialDone','trialSource','trialResult','trialNext','sparkResponse','updatedAt'];
  ...
  function worthKeeping(entry) {
    return !!entry && (won(entry) || entry.stories.length || entry.reminders.length || !!entry.trialPlan || !!entry.ref || !!entry.sparkResponse);
  }
  ...
  function render() {
    ...
    status(); renderHistory(); renderLibrary(); renderPersonal(); renderStart();
