...
(function(root) {
  ...
  function startSteps() {
    ...
    if (isSunday(day) && typeof root.weeklyMirrorReadOn === 'function' && !root.weeklyMirrorReadOn(day)) steps.push({kind:'read', kicker:'Start here · it’s Sunday', main:'Read your week back, then carry one thing forward.', go:'Read my week ↓'});
  ...
  function startGo() {
    ...
    else if (startKind === 'read') { expanded = true; render(); if (el('mirror-panel')) { el('mirror-panel').open = true; jumpTo(el('mirror-panel')); } }
