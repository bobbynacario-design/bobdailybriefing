...
(function(root) {
  ...
  function render() {
    ...
    if (switched) {
      account = uid; records = {}; baseline = {}; syncBase = {}; sentNotes = {}; archive = {}; archiveFor = null; failed = false; shownDay = null; resetSync();
  ...
  root.resetDailyBoost = function() { records = {}; archive = {}; archiveFor = null; account = null; day = null; expanded = false; shownDay = null; resetSync(); if (el('note')) { el('note').value = ''; el('history').replaceChildren(); el('feedback').textContent = ''; el('export').value = ''; el('export').hidden = true; el('copy-status').textContent = ''; el('noted').replaceChildren(); el('noted').hidden = true; } };
